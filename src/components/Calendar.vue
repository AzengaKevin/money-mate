    ...
    <v-col>
      <v-sheet height="64">
        <v-toolbar flat color="white">
          ...
          <v-toolbar-title class="primary--text" v-if="$refs.calendar">{{ $refs.calendar.title }}</v-toolbar-title>
          <v-spacer></v-spacer>
          <v-menu bottom right>
      ...
      <v-sheet height="600">
        <v-calendar ref="calendar" v-model="focus" color="primary"
          ...
          @click:event="showEvent" @click:more="viewDay" @click:date="viewDay" @change="updateRange"></v-calendar>
        <v-menu
